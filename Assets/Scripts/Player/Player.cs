    ...
    public partial class Player : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (!_isDashAttacking) {
                ...
                else if ((IsJumping || IsWallJumping || _isJumpFalling) && Mathf.Abs(rb2D.velocity.y) < Data.jumpHangTimeThreshold) {
        ...
        private void Run(float lerpAmount)
        {
            ...
            if ((IsJumping || IsWallJumping || _isJumpFalling) && Mathf.Abs(rb2D.velocity.y) < Data.jumpHangTimeThreshold) {
        ...
        private IEnumerator StartDash(Vector2 dir)
        {
            ...
            while (Time.time - startTime <= Data.dashAttackTime) {
                rb2D.velocity = dir.normalized * Data.dashSpeed;
            ...
            SetGravityScale(Data.gravityScale);
            rb2D.velocity = Data.dashEndSpeed * dir.normalized;
        ...
        private void Slide()
        {
            ...
            if (rb2D.velocity.y > 0) {
                rb2D.AddForce(-rb2D.velocity.y * Vector2.up, ForceMode2D.Impulse);
            }
